  ...
  public static void main(String args[]) throws IOException {
    ...
    while(true)
    {
        ...
        if (cadena.equals(checksum)) {
            ...
            pw.close();
             // Send a string!
            dos.writeUTF("Sensor registrado");
        } else  dos.writeUTF("El Checksum no es igual");
            ...
            String datosParaObsv;
                ...
                while(it.hasNext()){
                    ...
                    if(datosParaObsv.contains(sensorName)) {
                        dos.writeUTF("Ultima medicion del sensor solicitado: "+datosParaObsv); //envia los datos al Cliente
                        }
                }
